...
num_pendulums = 1  # Number of pendulums
pendulums = []
...
video_filename = 'double_pendulum_simulation.avi'
video = pygame.movie.Movie(video_filename, (WINDOW_WIDTH, WINDOW_HEIGHT))
video.set_quality(0.8)
...
for frame_num in range(num_frames):
    ...
    # Capture current frame and add it to the video
    video.add_frame(screen)
